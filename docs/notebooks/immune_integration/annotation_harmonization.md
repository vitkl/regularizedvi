...
| CD8+ T activated                              | CD8+ T activated            | bone_marrow           | l2_cell_type          |
...
| Plasma                                        | Plasma B cell               | bone_marrow           | l2_cell_type          |
...
| B intermediate                                | Intermediate B              | pbmc_tea_seq          | predicted.celltype.l2 |
...
| B memory                                      | Memory B                    | pbmc_tea_seq          | predicted.celltype.l2 |
...
| Plasmablast                                   | Plasma B cell               | pbmc_tea_seq          | predicted.celltype.l2 |
...
| C1                                            | CD4+ T activated            | neat_seq_cd4t         | Clusters              |
| C2                                            | Treg                        | neat_seq_cd4t         | Clusters              |
| C3                                            | CD4+ T Th17 memory          | neat_seq_cd4t         | Clusters              |
| C4                                            | CD4+ T central memory       | neat_seq_cd4t         | Clusters              |
| C5                                            | CD4+ T Th2 memory           | neat_seq_cd4t         | Clusters              |
| C6                                            | CD4+ T Th1 memory           | neat_seq_cd4t         | Clusters              |
...
| CD8+ Cytotoxic T Cells                        | level_1:CD8+ T-cell lineage | crohns_pbmc           | Celltypes             |
...
| Th1/Th17 Cells                                | CD4+ T Th1/Th17 memory      | crohns_pbmc           | Celltypes             |
...
| Plasma B Cells                                | Plasma B cell               | crohns_pbmc           | Celltypes             |
| TGFB1+ NK Cells                               | NK TGFB1+                   | crohns_pbmc           | Celltypes             |
| **Lung/Spleen GSE319044** (CellType column)   |                             |                       |                       |
| Memory_B                                      | Memory B                    | lung_spleen_gse319044 | CellType              |
| CD8_T                                         | level_1:CD8+ T-cell lineage | lung_spleen_gse319044 | CellType              |
| NK                                            | NK                          | lung_spleen_gse319044 | CellType              |
| CD4_T                                         | level_1:CD4+ T-cell lineage | lung_spleen_gse319044 | CellType              |
| Naive_B                                       | Naive B                     | lung_spleen_gse319044 | CellType              |
| Th17                                          | CD4+ T Th17 memory          | lung_spleen_gse319044 | CellType              |
| Other                                         | NaN                         | lung_spleen_gse319044 | CellType              |
