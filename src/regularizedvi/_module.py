"""VAE module for regularizedvi.

Copied verbatim from scvi-tools (scvi.module._vae) as a baseline.
Only the VAE class is included — LDVAE is not needed for regularizedvi.
"""
