    ...
    **model_kwargs
    ...
    def get_normalized_accessibility(
        ...
        if region_list is None:
            ...
            region_mask = [region in region_list for region in adata[adata.mod_names[1]].var_names[: self.n_regions]]
    ...
    def differential_accessibility(
        ...
        **kwargs
        ...
        model_fn = partial(self.get_normalized_accessibility, use_z_mean=False, batch_size=batch_size)
        ...
        result = pd.DataFrame(
            {
                ...
                "is_da_fdr": result.loc[:, f"is_de_fdr_{fdr_target}"] if mode == "change" else None,
