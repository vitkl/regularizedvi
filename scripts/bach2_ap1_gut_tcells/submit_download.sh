#!/bin/bash
# Submit BACH2/AP-1 Gut T Cells multiome download as a long queue job.
# Usage: bash scripts/bach2_ap1_gut_tcells/submit_download.sh
...
OUTPUT_DIR="/nfs/team205/vk7/sanger_projects/large_data/bach2_ap1_gut_tcells"
