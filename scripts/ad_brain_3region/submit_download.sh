#!/bin/bash
# Submit AD Brain 3-Region multiome download as a long queue job.
# Usage: bash scripts/ad_brain_3region/submit_download.sh
...
OUTPUT_DIR="/nfs/team205/vk7/sanger_projects/large_data/ad_brain_3region"
