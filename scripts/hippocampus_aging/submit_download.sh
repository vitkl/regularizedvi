#!/bin/bash
# Submit Hippocampus Aging multiome download as a long queue job.
# Usage: bash scripts/hippocampus_aging/submit_download.sh
...
OUTPUT_DIR="/nfs/team205/vk7/sanger_projects/large_data/hippocampus_aging"
