#!/bin/bash
# Submit RORγt+ DC-like Cells (Tonsil) multiome download as a long queue job.
# Usage: bash scripts/rorgt_dc_tonsil/submit_download.sh
...
OUTPUT_DIR="/nfs/team205/vk7/sanger_projects/large_data/rorgt_dc_tonsil"
