#!/bin/bash
# Submit Lung Smoking multiome download as a long queue job.
# Usage: bash scripts/lung_smoking/submit_download.sh
...
OUTPUT_DIR="/nfs/team205/vk7/sanger_projects/large_data/lung_smoking"
