...
| `library_size_key` | Library prior $\ell\_n \sim \text{LogNormal}(\ell\_p^{\mu}, 0.5 \cdot \ell\_p^{\sigma^2})$: per-group mean/var | No | No | `(1, n_lib_cats)` |
